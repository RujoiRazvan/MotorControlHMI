...
int EwBspDisplayInit( int aGuiWidth, int aGuiHeight, XDisplayInfo* aDisplayInfo )
{
  ...
  LtdcHandle.Init.AccumulatedHBP = (RK043FN48H_HSYNC + (RK043FN48H_HBP - 11) - 1);
  ...
  LtdcHandle.Init.AccumulatedActiveW = (RK043FN48H_WIDTH + RK043FN48H_HSYNC + (RK043FN48H_HBP - 11) - 1);
  LtdcHandle.Init.TotalHeigh = (RK043FN48H_HEIGHT + RK043FN48H_VSYNC + RK043FN48H_VBP + RK043FN48H_VFP - 1);
  LtdcHandle.Init.TotalWidth = (RK043FN48H_WIDTH + RK043FN48H_HSYNC + (RK043FN48H_HBP - 11) + RK043FN48H_HFP - 1);
  ...
  /* Enable Dithering */
  if ( HAL_LTDC_EnableDither( &LtdcHandle ) != HAL_OK )
    EwPrint( "EwBspConfigDisplay: Could not enable Dithering !\n" );
