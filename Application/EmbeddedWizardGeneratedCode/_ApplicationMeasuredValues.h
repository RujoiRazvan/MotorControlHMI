...
#ifndef _ApplicationMeasuredValues_H
#define _ApplicationMeasuredValues_H
...
/* Forward declaration of the class Application::MeasuredValues */
#ifndef _ApplicationMeasuredValues_
  EW_DECLARE_CLASS( ApplicationMeasuredValues )
#define _ApplicationMeasuredValues_
#endif
...
/* Deklaration of class : 'Application::MeasuredValues' */
EW_DEFINE_FIELDS( ApplicationMeasuredValues, CoreGroup )
  EW_OBJECT  ( splashTimer,     CoreTimer )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( Title,           ViewsText )
  EW_OBJECT  ( NumberOfCWrotations, ViewsText )
  EW_OBJECT  ( NumberOfCCWrotations, ViewsText )
...
EW_DEFINE_METHODS( ApplicationMeasuredValues, CoreGroup )
...
EW_END_OF_METHODS( ApplicationMeasuredValues )
...
#endif /* _ApplicationMeasuredValues_H */
